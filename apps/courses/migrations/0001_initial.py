# -*- coding: utf-8 -*-
# Generated by Django 1.9.8 on 2018-01-18 01:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree', models.CharField(choices=[('primary_level', '\u521d\u7ea7'), ('middle_level', '\u4e2d\u7ea7'), ('high_level', '\u9ad8\u7ea7')], max_length=20)),
                ('learning_time', models.IntegerField(default=0, verbose_name='\u5b66\u4e60\u65f6\u957f\uff08\u5206\u949f\u6570\uff09')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('download', models.FileField(upload_to='course/resourcee/%Y%m', verbose_name='\u8d44\u6e90\u6587\u4ef6')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='\u6dfb\u52a0\u65f6\u95f4')),
